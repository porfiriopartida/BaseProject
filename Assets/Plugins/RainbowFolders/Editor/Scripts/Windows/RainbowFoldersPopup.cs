...
using Plugins.RainbowFolders.Editor.Scripts.Menu;
using Plugins.RainbowFolders.Editor.Scripts.Settings;
using UnityEditor;
using UnityEngine;
using KeyType = Plugins.RainbowFolders.Editor.Scripts.Settings.RainbowFolder.KeyType;

namespace Plugins.RainbowFolders.Editor.Scripts.Windows
{
