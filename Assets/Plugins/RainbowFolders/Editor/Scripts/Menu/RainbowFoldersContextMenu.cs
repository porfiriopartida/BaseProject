...
using System.Linq;
using Plugins.RainbowFolders.Editor.Scripts.Helpers;
using Plugins.RainbowFolders.Editor.Scripts.Menu.Colors;
using Plugins.RainbowFolders.Editor.Scripts.Menu.Platforms;
using Plugins.RainbowFolders.Editor.Scripts.Menu.Tags;
using Plugins.RainbowFolders.Editor.Scripts.Menu.Types;
using Plugins.RainbowFolders.Editor.Scripts.Settings;
using Plugins.RainbowFolders.Editor.Scripts.Windows;
using UnityEditor;
using UnityEngine;

namespace Plugins.RainbowFolders.Editor.Scripts.Menu
{
